      ...
      <PageNav
        ...
        rightSlot={
          <button
            ...
            className="hidden sm:block text-xs font-semibold bg-violet-600 hover:bg-violet-500 text-white px-3 py-1.5 rounded-lg transition-colors"
          >
            Sign up
          </button>
        }
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className={`text-xs font-semibold ${labelCl}`}>
                    Password
                  </label>
                  <button
                    type="button"
